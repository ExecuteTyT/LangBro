...
async def cmd_help(message: Message, **kwargs):
    await message.answer(
        ...
        "<b>👤 Профиль:</b>\n"
        "/profile — просмотр/обновление профиля\n"
        "/switch — переключить челлендж\n"
        "/vacation <дни> — каникулы (1-7 дней)\n\n"
        "<b>⚙️ Администрирование (только админы):</b>\n"
        "/create_challenge — создать челлендж\n"
        "/launch — отправить приглашение\n"
        "/settings — настройки челленджа\n"
        "/kick @username — удалить участника\n"
